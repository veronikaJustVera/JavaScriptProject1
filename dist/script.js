...
/* harmony import */ var _checkTypeInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkTypeInputs */ "./src/js/modules/checkTypeInputs.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkTypeInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#width', '[^\\d]+');
  Object(_checkTypeInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height', '[^\\d]+');
  ...
  function _bindSingleElement(element, event, property) {
...
/***/ "./src/js/modules/checkTypeInputs.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkTypeInputs.js ***!
  \*******************************************/
/*! exports provided: default */
...
var checkTypeInputs = function checkTypeInputs(inputSelector, regular) {
  var flagsRegular = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
...
/* harmony default export */ __webpack_exports__["default"] = (checkTypeInputs);
...
/* harmony import */ var _checkTypeInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkTypeInputs */ "./src/js/modules/checkTypeInputs.js");
...
var forms = function forms(state) {
  ...
  Object(_checkTypeInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]', '[^\\d\\s]+', 'gi');
    ...
    form.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (result) {
        ...
        if (form.dataset.closeModal) {
          var formModal = document.querySelector('.' + form.dataset.closeModal);
...
var modals = function modals() {
   ...
   */
  function bindModal(evt, triggerSelector, modalSelector, closeSelector) {
    var closeClickOverlay = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
    var needCheckInputs = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
    var checkInputsParentSelector = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '';
    ...
    trigger.forEach(function (item) {
      item.addEventListener(evt, function (e) {
        ...
        var inputsChecked = true;

        if (needCheckInputs && checkInputsParentSelector) {
          var inputsForCheck = document.querySelectorAll(checkInputsParentSelector + ' input');
          inputsForCheck.forEach(function (inputForCheck) {
  ...
  function _closeAllModals() {
    var modalsElements = document.querySelectorAll('[data-modal]');
    modalsElements.forEach(function (modalsElement) {
...
var tabs = function tabs() {
  ...
  function bindTabs(headerSelector, tabSelector, contentSelector, activeClass) {
    var displayValue = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
    ...
    header.addEventListener('click', function (e) {
      ...
      if (target && (target.classList.contains(tabClassName) || target.parentNode.classList.contains(tabClassName))) {
...
var timer = function timer(id, deadline) {
  ...
  var _formatDate = function _formatDate(dateValue) {
